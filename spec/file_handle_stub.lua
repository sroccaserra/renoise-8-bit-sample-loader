...
FORM_CHUNK = bytes_from_hex('464f524d'..  -- 'FORM'
                            '0000270a'..  -- chunk length after this ulong (the file size minus 8)
                            '38535658')   -- '8SVX'
VHDR_CHUNK = bytes_from_hex('56484452'..  -- 'VHDR'
...
NAME_CHUNK = bytes_from_hex('4e414d45'..  -- 'NAME'
                            '00000018')   -- chunk length
ANNO_CHUNK = bytes_from_hex('414e4e4f'..  -- 'ANNO'
                            '00000010')   -- chunk length
BODY_CHUNK = bytes_from_hex('424f4459'..  -- 'BODY'
